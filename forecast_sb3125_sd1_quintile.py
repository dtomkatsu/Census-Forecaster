"""SB 3125 SD1 quintile distributional analysis (MID scenario, TY 2027-2031).
...
def main() -> None:
    ...
    for yr in TARGET_YEARS:
        ...
        sb3125_cfg   = TaxSystemRegistry.get_sb3125_sd1_system(yr)
    ...
    Q_CSV = Path("/tmp/sb3125_sd1_quintile_revised_2027_2031.csv")
    B_CSV = Path("/tmp/sb3125_sd1_bracket_revised_2027_2031.csv")
    ...
    print("\n" + "=" * 100, flush=True)
    print("SB 3125 SD1 vs Act 46 — MID Scenario, TY 2027 (full revised pipeline)", flush=True)
    ...
    print(
        ...
        f"\n  SB 3125 SD1 scenario:   ${total_sb:>9.1f}M"
...
def _make_pdf(df: pd.DataFrame) -> None:
    ...
    PDF_OUT = Path("/tmp/sb3125_sd1_quintile_distributional_report.pdf")
    ...
    def table_page(pdf):
        ...
        fig.suptitle(
            "SB 3125 SD1 vs Act 46 — Distributional Impact (MID Scenario)",
    ...
    with PdfPages(PDF_OUT) as pdf:
        ...
        chart_page(pdf, avg_chart_title,
                   "SB 3125 SD1 vs Act 46 — MID Scenario",
                   avg_col, "dollar", BLUE)
        ...
        m = pdf.infodict()
        m["Title"] = "SB 3125 SD1 Distributional Analysis (Revised Pipeline)"
