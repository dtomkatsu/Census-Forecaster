...
| `bls_national_unemployment.json` | BLS LNS14000000 (CPS, SA, annual avg) | **nothing — anchor registration tried and rejected** (blended-RMSE regression + rate-band violation; see market_ml_ablation_2026-07-14.md). Refreshed for the causal screen only | bls.gov |
