...
- **`SB3125_CD1_FORECAST.md` MUST be updated before committing** whenever methodology, parameters, scenario design, behavioral channels, tax treatment, k-values, or results tables change. The doc has a maintenance note pointing here. Update the relevant sections, the Section 10 results table, and the decomposition.
...
- `SB3125_CD1_FORECAST.md` — SB 3125 CD1 methodology, scenarios, results.
