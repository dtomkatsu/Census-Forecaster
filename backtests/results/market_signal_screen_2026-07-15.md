# Market-signal screen — 2026-07-15

Pre-registered ticker→target hypotheses (24 pairs), Granger F-tests on monthly log-returns at lags 3/6/12, BH-FDR q=0.1. 63 tests run.
...
## 2020 excluded (COVID sensitivity) — 57 tests
