"""SB 3125 CD2 fiscal-impact sensitivity analysis.
...
Output:
  /tmp/sb3125_cd2_sensitivity_2027_2031.csv
"""
...
OUT_CSV = Path("/tmp/sb3125_cd2_sensitivity_2027_2031.csv")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n" + "=" * 90, flush=True)
        print("SB 3125 CD2 FISCAL IMPACT SENSITIVITY ($M, vs Act 46 baseline)", flush=True)
        print("=" * 90, flush=True)
